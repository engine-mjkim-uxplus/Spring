...
public class BoardController {
	...
	@ResponseBody
	@GetMapping(value="helloworld.sp4", produces="text/plain;charset=UTF8") //produces="text/plain;charset=UTF8 -> 한글처리
	public String helloWorld() {
	    return "한글처리";
	} // return
	// http://localhost:9000/step1/board/jsonFormat.sp4
	@ResponseBody
	@GetMapping(value="jsonFormat.sp4", produces="application/json;charset=UTF8") //produces="text/plain;charset=UTF8 -> 한글처리
